...
YOOMONEY_RECEIVER: str = os.getenv("YOOMONEY_CLIENT_ID") or os.getenv("YOOMONEY_RECEIVER") or ""
YOOMONEY_REDIRECT_URI: str = os.getenv("YOOMONEY_REDIRECT_URI") or os.getenv("YOOMONEY_REDIRECT_URI_PROD") or ""
